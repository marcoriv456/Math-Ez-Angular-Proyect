import {AfterViewInit, Component, HostBinding, inject, NgZone, OnDestroy} from '@angular/core';
...
export class HeaderComponent implements AfterViewInit,OnDestroy{
  @HostBinding('style') schema = this.transformSchemaToCssVariables(ColorSchemas.DEFAULT);
