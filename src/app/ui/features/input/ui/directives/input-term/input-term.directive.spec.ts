...
describe('InputTermDirective', () => {
  ...
  beforeEach( async () => {
    ...
    const debugEl = fixture.debugElement.query(By.directive(InputTermDirective));
    directive = debugEl.injector.get(InputTermDirective);
    element = debugEl.nativeElement as HTMLElement
    Object.defineProperty(element, 'offsetWidth', {get(): any {return 150}, configurable: true})
  });
  ...
  it('should calculate leftPosition correctly when parent elements exist', () => {
    ...
    jest.spyOn(mockParent1, 'parentElement', 'get').mockReturnValue(mockParent2);
    jest.spyOn(mockParent2, 'parentElement', 'get').mockReturnValue(mockAppInput);
