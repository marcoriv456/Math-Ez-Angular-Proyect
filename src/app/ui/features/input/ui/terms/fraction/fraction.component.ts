...
import { FractionDenominatorValidator } from '../../../core/validation/validators/fraction/fraction-denominator/fraction-denominator.validator';
import { FractionNumeratorValidator } from '../../../core/validation/validators/fraction/fraction-numerator/fraction-numerator.validator';
...
export class FractionComponent extends InputMathElement<FractionTerm> {
  protected readonly FractionDenominatorValidator =
