...
describe('Root validator: ', () => {
  const getRootValidator = (radicand:string, base:string) => new RootValidator({type:'root', rootChildren:TermUtils.parse(radicand), radicalTerms:TermUtils.parse(base)});
