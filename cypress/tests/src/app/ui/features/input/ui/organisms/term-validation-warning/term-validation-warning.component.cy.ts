...
import { TermValidationWarningRenderData } from '../../../../../../../../../../src/app/ui/features/input/core/validation/models/term-validation-warning-render-data.model';
import { WarningShowRequestEvent } from '../../../../../../../../../../src/app/ui/features/input/core/models/events/warnings/warning-show-request.event';
...
describe('Term validation warning: ', () => {
  ...
  it('Displays correctly the positioning style', () => {
    let warningData: TermValidationWarningRenderData = {
      messages: [{ message: 'test message', type: 'fully-invalid' }],
      position: { x: 100, y: 50 },
    };
  ...
  it('Displays the sent message', () => {
    ...
    cy.get('.warning-container span').should('contain.text', 'test message');
  });
  ...
  it('Displays the message with a fully-invalid class', () => {
    ...
    cy.get('.warning-container span').should('have.class', 'fully-invalid');
  });

  it('Displays the message with a partially-invalid class', () => {
    let warningData: TermValidationWarningRenderData = {
      messages: [{ message: 'test message', type: 'partially-invalid' }],
      position: { x: 100, y: 100 },
    };
    ...
    cy.get('.warning-container span').should('have.class', 'partially-invalid');
  });
